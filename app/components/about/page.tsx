    ...
    <div className="relative min-h-screen bg-(--bg-primary) text-(--text-primary) overflow-hidden">
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center text-center gap-8 pb-10">
          <p className="text-xs tracking-[0.3em] text-(--text-primary)/30 uppercase">
            Est. 2026
          </p>
          ...
          <p className="text-(--text-primary)/40 text-lg max-w-lg leading-relaxed">
          ...
          <div className="flex items-center gap-4 mt-4">
            ...
            <a
              href="#mission"
              className="px-8 py-3 rounded-full font-semibold text-sm border border-white/10 text-(--text-primary)/60 hover:text-(--text-primary) hover:border-white/30 transition-all duration-200"
            >
              Learn More
            </a>
          </div>
        ...
        <section id="mission" className="py-24 border-t border-(--border)">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-xs tracking-[0.3em] text-(--text-primary) uppercase mb-6">
                Our Mission
              </p>
        ...
        <section className="py-24 border-t border-(--border)">
          <p className="text-xs tracking-[0.3em] text-(--text-primary) uppercase mb-16">
            Features
          </p>
          <div className="grid md:grid-cols-3 gap-px bg-white/5 rounded-3xl overflow-hidden">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group bg-(--bg-primary) hover:bg-white/1 p-10 transition-all duration-300"
              >
                ...
                <p className="text-(--text-primary)/30 text-sm leading-relaxed">
                  {feature.description}
                </p>
              </div>
            ))}
        ...
        <section className="py-24 border-t border-(--border)">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {values.map((value, idx) => (
              <div
                key={idx}
                className="group flex items-start gap-6 p-8 rounded-2xl border border-(--border) hover:border-gray-500/20 hover:bg-white/11 transition-all duration-300"
              >
        ...
        <section className="py-8 border-t border-(--border) text-center">
          <p className="text-xs tracking-[0.3em] text-(--text-primary)/20 uppercase mb-5">
            Ready?
          </p>
